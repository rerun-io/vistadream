...
def parse_img_cond_path(options: SamplingOptions | None) -> SamplingOptions | None:
    ...
    while True:
        ...
        if not os.path.isfile(img_cond_path) or not img_cond_path.lower().endswith((".jpg", ".jpeg", ".png", ".webp")):
...
def parse_img_mask_path(options: SamplingOptions | None) -> SamplingOptions | None:
    ...
    while True:
        ...
        if not os.path.isfile(img_mask_path) or not img_mask_path.lower().endswith((".jpg", ".jpeg", ".png", ".webp")):
